...
!(function (a, b) {
  ...
  const x = (function (a) {
    ...
    const ea = ta(
      (a) => a.disabled === !0 && ('form' in a || 'label' in a),
      ...
      return g !== n && g.nodeType === 9 && g.documentElement
        ...
        c.getById
          ...
          : ((d.filter.ID = function (a) {
            const b = a.replace(_, aa);
            return function (a) {
              const c = typeof a.getAttributeNode !== 'undefined'
  ...
  function na(a, b) {
    let c;
    return (
      (c = typeof a.getElementsByTagName !== 'undefined'
    ...
    return this instanceof r.Event
      ? (a && a.type
        ...
        (this.isDefaultPrevented = a.defaultPrevented
          ...
          ? va
          : wa),
        (this.target = a.target && a.target.nodeType === 3
          ? a.target.parentNode
          : a.target),
      ...
      return (
        `${parseFloat(Oa(a, 'marginLeft'))
            || a.getBoundingClientRect().left
              - ea(a, { marginLeft: 0 }, () => a.getBoundingClientRect().left)}px`
      );
    }
  })),
      ...
      return this.map(function () {
        ...
        .map(function (a, b) {
          ...
          return c == null
            ? null
            : Array.isArray(c)
              ? r.map(c, (a) => ({ name: b.name, value: a.replace(xb, '\r\n') }))
