...
+(function (a) {
  ...
  a(document)
    .on('click.bs.button.data-api', '[data-toggle^="button"]', (c) => {
...
+(function (a) {
  ...
  (c.prototype.slide = function (b, d) {
    ...
    const j = f[0];
    const k = a.Event('slide.bs.carousel', { relatedTarget: j, direction: h });
...
+(function (a) {
  ...
  (c.prototype.enter = function (b) {
    let c = b instanceof this.constructor
      ? b
  ...
  (c.prototype.show = function () {
    ...
    if (this.hasContent() && this.enabled) {
      ...
      let h = typeof this.options.placement === 'function'
  ...
  (c.prototype.getPosition = function (b) {
    ...
    const g = d ? { top: 0, left: 0 } : f ? null : b.offset();
    const h = {
      scroll: d
